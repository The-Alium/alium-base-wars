...
BaseWars.Config = {
    ...
    Rules = {
        ...
        HTML = "https://steamcommunity.com/groups/thealium",
    },
...
BaseWars.SpawnList.Loadout["Weapons (T1)"] = {
    ...
    ["Colt M1911"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Level = 0, Price = 7000, ClassName = "tacrp_ex_m1911"},
    ["Berreta 92FS"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_elite_single.mdl", Level = 0, Price = 10000, ClassName = "tacrp_vertec"},
    ["Glock 17"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_glock18.mdl", Price = 12000, Level = 0, ClassName = "tacrp_ex_glock"},
    ["HK USP"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Price = 13000, Level = 0, ClassName = "tacrp_ex_usp"},
    ["SIG P250"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_p228.mdl", Price = 14000, ClassName = "tacrp_p250"},
    ["SIG 1911"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Price = 14000, ClassName = "tacrp_gsr1911"},
    ["P2000"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Price = 16000, ClassName = "tacrp_p2000"},
    ["HK45 Compact"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_p228.mdl", Price = 21000, ClassName = "tacrp_ex_hk45c"},
    ["Manurhin MR96"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_deagle.mdl", Price = 25000, ClassName = "tacrp_mr96"},

    ["Dual MTX"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_elite.mdl", Price = 35000, ClassName = "tacrp_mtx_dual"},

    ["Skorpion"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_mac10.mdl", Price = 40000, ClassName = "tacrp_skorpion"},
    ["Sphinx 2000"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_fiveseven.mdl", Price = 41000, ClassName = "tacrp_sphinx"},
    ["Springfield XD-45"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_fiveseven.mdl", Price = 43000, ClassName = "tacrp_xd45"},
    ["HK MP5A3"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_mp5.mdl", Price = 60000, ClassName = "tacrp_mp5"},
    ["Ingram MAC-11"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_mac10.mdl", Price = 62000, ClassName = "tacrp_ex_mac10"},
    ["IMI Uzi Pro"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_mac10.mdl", Price = 64000, ClassName = "tacrp_uzi"},
    ["HK UMP45"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_ump45.mdl", Price = 68000, ClassName = "tacrp_ex_ump45"},
    ["HK MP7"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_tmp.mdl", Price = 70000, ClassName = "tacrp_mp7"},
    ["Daewoo K1A"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_galil.mdl", Price = 73000, ClassName = "tacrp_k1a"},

    ["Molot Bekas 16-M"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_shot_m3super90.mdl", Price = 75000, ClassName = "tacrp_bekas"},
    ["TGS12"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_shot_m3super90.mdl", Price = 75000, ClassName = "tacrp_tgs12"},

}

BaseWars.SpawnList.Loadout["Ammo Kits"] = {

    ["Ammo Kit"] = BaseWars.GSL{Ammo = true, Model = "models/weapons/tacint/ammoboxes/ammo_bag-1.mdl", Price = 5000, ClassName = "tacrp_ammo"},
    ["Ammo Crate"] = BaseWars.GSL{Ammo = true, Model = "models/weapons/tacint/ammoboxes/ammo_box-2.mdl", Price = 50000, ClassName = "tacrp_ammo_crate"},

}

BaseWars.SpawnList.Loadout["Meds"] = {

    ["Med Kit"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_medkit.mdl", Price = 100000, ClassName = "tacrp_medkit", Level = 1},

}

BaseWars.SpawnList.Loadout["Weapons (Grenades)"] = {

    ["Breaching Charge"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/door_charge-1.mdl", Price = 150000, ClassName = "tacrp_nade_charge", Level = 15},
    ["CS Gas Granate"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_smoke.mdl", Price = 100000, ClassName = "tacrp_nade_gas", Level = 15},
    ["Flashbang"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/flashbang.mdl", Price = 100000, ClassName = "tacrp_nade_flashbang", Level = 15},
    ["Frag Grenade"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_frag.mdl", Price = 100000, ClassName = "tacrp_nade_frag", Level = 15},
    ["Medic-Smoke"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_smoke.mdl", Price = 100000, ClassName = "tacrp_nade_heal", Level = 15},
    ["Smoke Grenade"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_smoke.mdl", Price = 100000, ClassName = "tacrp_nade_smoke", Level = 15},
    ["Thermite"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_smoke.mdl", Price = 100000, ClassName = "tacrp_nade_thermite", Level = 15},
    ["C4"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/c4_charge-1.mdl", Price = 1500000, ClassName = "tacrp_ammo_c4", Level = 30},

}

BaseWars.SpawnList.Loadout["Weapons (T2)"] = {

    ["MP9"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_tmp.mdl", Price = 75000, ClassName = "tacrp_ex_mp9"},
    ["KAC PDW"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_m4a1.mdl", Price = 80000, ClassName = "tacrp_pdw"},
    ["FN P90"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_p90.mdl", Price = 82000, ClassName = "tacrp_p90"},
    ["HK FABARAM FP6"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_shot_m3super90.mdl", Price = 84000, ClassName = "tacrp_fp6"},
    ["KRISS Vector"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_smg_mac10.mdl", Price = 85000, ClassName = "tacrp_superv"},
    ["SIG SG 551"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_sg552.mdl", Price = 90000, ClassName = "tacrp_sg551"},
    ["AK47"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_ak47.mdl", Price = 95000, ClassName = "tacrp_ex_ak47"},
    ["Colt M4A1"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_m4a1.mdl", Price = 98000, ClassName = "tacrp_ex_m4a1"},
    ["Dieamaco C8A1"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_m4a1.mdl", Price = 99000, ClassName = "tacrp_m4"},
    ["HK G36K"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_sg552.mdl", Price = 99000, ClassName = "tacrp_g36k"},
    ["Steyr AUG A2"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_aug.mdl", Price = 100000, ClassName = "tacrp_aug"},
    ["KS-23"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_shot_m3super90.mdl", Price = 100000, ClassName = "tacrp_ks23"},
    ["AMD65"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_galil.mdl", Price = 105000, ClassName = "tacrp_amd65"},
    ["FB Beryl 96"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_rif_ak47.mdl", Price = 110000, ClassName = "tacrp_ak47"},
    ["Benelli M4"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_shot_xm1014.mdl", Price = 115000, ClassName = "tacrp_m4star10"},
    ["Heal Gun"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_physics.mdl", Price = 1000000, ClassName = "bw_health", Level = 45},

    ["Flip Knife"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_knife_ct.mdl", Price = 200000, ClassName = "tacrp_knife"},
    ["Jackal Knife"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_knife_t.mdl", Price = 200000, ClassName = "tacrp_knife2"},
}

BaseWars.SpawnList.Loadout["Weapons (T3)"] = {

    ["M14"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_snip_sg550.mdl", Price = 200000, ClassName = "tacrp_m14"},
    ["Remington M700"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_snip_scout.mdl", Price = 300000, ClassName = "tacrp_spr"},
    ["PGM Ultima L-Ratio"] = BaseWars.GSL{Gun = true, Model = "models/weapons/w_snip_awp.mdl", Price = 500000, ClassName = "tacrp_uratio"},
    ["RPG"] = BaseWars.GSL{Gun = true, Model = "models/weapons/tacint/w_rpg7.mdl", Price = 15000000, ClassName = "tacrp_rpg7"},
...
BaseWars.SpawnList.Entities["Structures (T2)"] = {
    ...
    -- T2
    ["Bank"] = BaseWars.GSL{Model = "models/props_lab/reciever01a.mdl", Price = 1000000, ClassName = "bw_bank_system"},
...
BaseWars.SpawnList.Entities["Vehicles"] = {
    ["M1A1 Abrams"] = BaseWars.GSL{Model = "models/kali/vehicles/MW2/M1A1_Abrams.mdl", Price = 35000000, ClassName = "glide_m1a1_abrams", UseSpawnFunc = true},
    ["T-84 BM Oplot"] = BaseWars.GSL{Model = "models/damik/ukraine/t-84 oplot m/t-84 oplot m -green- (ragdoll).mdl", Price = 35000000, ClassName = "glide_oplot", UseSpawnFunc = true},
    ["Humvee (no armed)"] = BaseWars.GSL{Model = "models/zenius/humvee/humvee_no_armed.mdl", Price = 15000000, ClassName = "glide_humvee_no_armed", UseSpawnFunc = true},
    ["Humvee armed"] = BaseWars.GSL{Model = "models/zenius/humvee/humvee_no_armed.mdl", Price = 25000000, ClassName = "glide_humvee_armed", UseSpawnFunc = true},
}
