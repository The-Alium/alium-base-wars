...
BaseWars.SpawnList.Loadout["Weapons (T1)"] = {
	...
	["Colt M1911"] 				    = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Price = 7000, ClassName = "tacrp_ex_m1911"},
	["Berreta 92FS"] 				= BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_elite_single.mdl", Price = 10000, ClassName = "tacrp_vertec"},
	["Glock 17"] 			        = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_glock18.mdl", Price = 12000, ClassName = "tacrp_ex_glock"},
	["HK USP"] 					    = BaseWars.GSL{Gun = true, Model = "models/weapons/w_pist_usp.mdl", Price = 13000, ClassName = "tacrp_ex_usp"},
